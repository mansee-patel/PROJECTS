...
<br><br>
	...
	<?php
        ...
        $sel = "SELECT * FROM booking, (SELECT * from user) as t1 where booking.user_id=t1.user_id ";
...
?>
    ...
    <table id="customers" style="margin-top: 250px;margin-left: -30px;border-radius: 40px" bgcolor="lightgray">
    	<tr>
    				...
    				<th  style="color: white;background-color: black">Booking Id</th>
			        <th style="color: white;background-color: black">User Id</th>
			        <th style="color: white;background-color: black">Package Id </th>
			        <th style="color: white;background-color: black">Package Name</th>
			        <th style="color: white;background-color: black">passengers</th>
			        <th style="color: white;background-color: black">date</th>
			        <th style="color: white;background-color: black">Cost</th> 
			        <th style="color: white;background-color: black">Email Address</th>
			        	<th style="color: white;background-color: black">Delete Booking</th>
  ...
  ?>              	
            	<tr style="text-align: center;">
			        ...
			        <td><?php echo $row['email']?></td>
			     	<td><?php echo '<a style="color:black;text-decoration:none" href="delete2.php?rn='.$row['booking_id'].'">' ?> Delete</td>
            	</tr>
            	<?php          
            }
        }
