...
<div>
	<div style="background-color: #393e3f;width: 300px;height: 90px;margin-left: 400px;margin-top: 100px;border-radius: 20px;color: white">
		<button style="margin-left: 75px;margin-top: 27px;height: 40px;width: 150px;border-radius: 20px;background-color: white;color: black" onclick="window.location.href='viewuser.php'"><b>View User details</b></button>
...
?>
    ...
    <table id="customers" style="margin-top: 250px;margin-left: -30px;border-radius: 40px" bgcolor="lightgray">
    	<tr>
			        <th style="background-color: black;color: white">User Id</th>
			        <th style="background-color: black;color: white">Name </th>
			        <th style="background-color: black;color: white">Email Address</th>
